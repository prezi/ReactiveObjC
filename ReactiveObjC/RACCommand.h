...
- (instancetype)initWithSignalBlock:(RACSignal * (^)(id _Nullable input))signalBlock;
...
- (instancetype)initWithEnabled:(nullable RACSignal *)enabledSignal signalBlock:(RACSignal * (^)(id _Nullable input))signalBlock;
...
- (RACSignal *)execute:(nullable id)input;
