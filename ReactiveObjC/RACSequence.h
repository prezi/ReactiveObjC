...
- (nullable id)objectPassingTest:(BOOL (^)(id _Nullable value))block;
...
+ (RACSequence *)return:(nullable id)value;
...
/// `reduceBlock`.
+ (RACSequence *)zip:(id<NSFastEnumeration>)sequences reduce:(RACReduceBlock)reduceBlock;
